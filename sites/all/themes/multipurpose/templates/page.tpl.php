...
<div id="wrap" class="clr container">
      ...
      <div id="header-social" class="clr">
        <ul>
          ...
          <?php if ($twitter_url): ?><li>
            <a target="_blank" title="<?php print $site_name; ?> in YouTube" href="<?php print $twitter_url; ?>"><img alt="YouTube" src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/social/youtube.png'; ?>"> </a>
          </li><?php endif; ?>
  ...
  <div id="site-navigation-wrap">
    ...
    <nav id="site-navigation" class="navigation main-navigation clr" role="navigation">
      <div id="main-menu" class="menu-main-container menu-front-page-menu">
        <?php 
          $main_menu_tree = menu_tree('menu-front-page-menu');
